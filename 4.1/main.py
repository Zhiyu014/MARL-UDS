...
for n in range(N):
    ...
    for num in range(rain_num):
        ...
        vdnn.memory.append(observs,actions,reward,next_observs)
    ...
    test_reward,acts,test_loss = env.test(vdnn,rain,test_inp_file = './test/testVDN.inp')
...
axM.set_title('test reward history')
