...
from tensorflow import expand_dims,convert_to_tensor,float32,squeeze,GradientTape,reduce_sum,reduce_mean
...
class A2C:
    ...
    def actor_update(self,s, a, advs, i=None):
        ...
        with GradientTape() as tape:
            ...
            # probs = actor.model(s)
            # policy_loss = self.act_loss_fn(a,probs,sample_weight=advs)
            # policy_loss += reduce_mean(self.lambda_entropy*ks.losses.categorical_crossentropy(probs, probs))
