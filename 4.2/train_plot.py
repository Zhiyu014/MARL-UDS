...
test = ax.plot(np.arange(len(test_reward_history)),test_reward_history,'skyblue')
...
train = axR.plot(np.arange(len(episode_reward_history)),episode_reward_history,'orangered')
axR.set_xlabel('Episode')
axR.set_ylabel('Traing Reward')
